...
Также можно добавить свой сервис через supported_services.json, указав сервис в соответственный массив. Такжа приложение поддерживает ручной ввод подписок.
